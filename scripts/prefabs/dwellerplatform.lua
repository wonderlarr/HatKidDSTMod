...
return Prefab("dwellerplatform", fn, assets, prefabs),
       Prefab("dwellerplatform_player_collision", boat_player_collision_fn),
       Prefab("dwellerplatform_item_collision", boat_item_collision_fn),
       Prefab("dwellerplatform_item", item_fn, item_assets, item_prefabs),
       MakePlacer("dwellerplatform_item_placer", "dwellerplatform_01", "dwellerplatform_test", "idle_full", true, false, false, nil, nil, nil, nil, 6)
