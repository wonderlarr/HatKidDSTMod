...
-- Crafting Perk
TUNING.HATKID_FASTCRAFTING = GetModConfigData("hatkid_fastcrafting")
TUNING.HATKID_CRAFT_SANITY = GetModConfigData("hatkid_craft_sanity")
TUNING.HATKID_DISCOUNT = GetModConfigData("hatkid_discount")
...
TUNING.BREWINGHAT_FUELMULT = GetModConfigData("brewfuelmult")
...
TUNING.POLARHAT_FUELMULT = GetModConfigData("polarfuelmult")
...
TUNING.POLARHAT_THRESHHOLD = GetModConfigData("polarthreshhold")
...
TUNING.POLARHAT_DAMAGE = GetModConfigData("polardamage")
...
TUNING.TIMESTOPHAT_VALUE = GetModConfigData("timestopfuelvalue")
...
TUNING.HATKID_FAST_HATS = {
    ...
    "ruinshat",
    "molehat",
    -- "wathgrithrhat", -- wigfrid only
    -- "walterhat", -- walter only
    "icehat",
    "rainhat",
    "catcoonhat",
    "watermelonhat",
    ...
    -- "mermhat", -- wurt only
    "cookiecutterhat",
    -- "batnosehat", -- look into this more
    "nutrientsgoggleshat",
    "plantregistryhat",
    -- "balloonhat", -- wes only
    -- "alterguardianhat",
